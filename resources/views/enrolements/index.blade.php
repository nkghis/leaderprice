...
@section('title', 'Gestion des enrôlements')
            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h3 class="modal-title">
                            <button type="button" class="btn btn-primary">
                                <strong>{{ str_plural('Enrôlement', $result->count()) }}</strong> <span class="badge badge-danger">{{ $result->total() }}</span>
                            </button>
                    ...
                    <div class="col-md-4 page-action text-right">
                        @can('add_enrolements')
                            <a href="{{ route('enrolements.create') }}" class="btn btn-primary btn-sm"> <i class="material-icons">open_in_new</i> <b>Nouveau</b></a>
                        @endcan
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-sm" id="data-table">
                        ...
                        <tr>
                            ...
                            <th>Téléphone</th>
                            <th>Date Création</th>
                            @can('edit_enrolements', 'delete_enrolements')
                            ...
                            <tr>
                                ...
                                @can('edit_enrolements', 'delete_enrolements')
                                    <td class="text-center">
                                        @include('enrolements.shared._action', [
                                            'entity' => 'enrolements',
                                            'id' => $item->id
                                        ])
                                    </td>
