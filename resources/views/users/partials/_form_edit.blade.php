...
<div class="form-group row {{ $errors->has('name') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="text" name="name" id="input-name" class="form-control form-control-sm{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Albert KOFFI') }}" value="{{ old('name', $user->name) }}"  autofocus>
...
<div class="form-group row {{ $errors->has('email') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-8">
        <input type="email" name="email" id="input-email" class="form-control form-control-sm{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('albert.koffi@iconecom.net') }}" value="{{ old('email', $user->email) }}" >
...
<div class="form-group row @if ($errors->has('roles')) has-error @endif">
    ...
    <div class="col-md-8">
        {!! Form::select('roles[]', $roles, $userRole,  ['class' => 'form-control form-control-sm', 'multiple']) !!}
