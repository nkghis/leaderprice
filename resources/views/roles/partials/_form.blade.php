...
<div class="form-group row {{ $errors->has('role') ? ' has-danger' : '' }}">
    ...
    <div class="col-md-9">
        <input type="text" name="role" id="input-name" class="form-control form-control-sm{{ $errors->has('role') ? ' is-invalid' : '' }}" placeholder="{{ __('Administrateur') }}" value="{{ old('role') }}"  autofocus>
